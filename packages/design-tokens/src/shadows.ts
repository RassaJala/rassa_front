...
export const darkShadows = {
  ...
  'md-border':
    '0 4px 6px -1px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.05)',
  'lg-border':
    '0 10px 15px -3px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.05)',
  'xl-border':
...
export const getShadow = (
  ...
  mode === 'dark' && level in darkShadows
    ? darkShadows[level as keyof typeof darkShadows]!
    : shadows[level];
