...
const styles = StyleSheet.create({
  ...
  ordersTable: { backgroundColor: "#fff", borderRadius: 16, overflow: "hidden", shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3 },
  tableHead: { flexDirection: "row", backgroundColor: "#f1f5f9", paddingHorizontal: 16, paddingVertical: 12 },
  tableHeadCell: { flex: 1, fontWeight: "700", fontSize: 12, color: "#64748b", textTransform: "uppercase" },
  tableRow: { flexDirection: "row", paddingHorizontal: 16, paddingVertical: 13, borderTopWidth: 1, borderTopColor: "#f1f5f9", alignItems: "center" },
